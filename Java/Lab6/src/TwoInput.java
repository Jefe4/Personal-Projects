...
// reads a text file and creates a array list using the text file to input two inputs from the user.
// calculates the number of words between the two inputs and displays the results
